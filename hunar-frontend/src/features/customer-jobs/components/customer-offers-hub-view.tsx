      ...
      <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-sm border border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-5">
        <div className="space-y-1.5">
          ...
          <p className="text-xs sm:text-sm text-slate-500 max-w-2xl">
            {isUrdu
              ? "تصدیق شدہ کاریگروں کے ریٹس کا موازنہ کریں، نادرا اسناد دیکھیں اور ہنر تحفظ کے ساتھ وزٹ بک کریں۔"
              : "Compare verified technician quotes, inspect NADRA credentials, and confirm bookings with Hunar verified protection."}
          </p>
        </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-base font-bold text-[#123B5D]">
                  {isUrdu ? "ہنر تصدیق شدہ کوالٹی" : "Hunar Verified Quality"}
                </h4>
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              {isUrdu ? (
                <>
                  آپ کی سروس <strong className="text-[#123B5D]">ہنر ویریفائیڈ گارنٹی</strong> کے تحت محفوظ ہے۔ تمام کاریگر نادرا سی این آئی سی سے تصدیق شدہ ہیں اور موقع پر شفاف معائنہ فراہم کرتے ہیں۔
                </>
              ) : (
                <>
                  Your service is protected by <strong className="text-[#123B5D]">Hunar Verified Guarantee</strong>. Technicians are NADRA CNIC verified and provide transparent diagnosis directly on site.
                </>
              )}
            </p>
