...
export const MOCK_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Zero hidden markups. The amount agreed upon during the technician's on-site quote is the exact total you pay. HUNAR believes in fair, transparent pricing on all home service bookings.",
  },
  {
    id: "faq-price-4",
    category: "pricing",
  ...
  // SAFETY PIN & DOORSTEP CHECKLIST
  {
    ...
    answer:
      "For your family's protection, a unique 4-digit Safety PIN is generated when you book any visit. When the technician reaches your doorstep, ask for the PIN or have them verify it to ensure they are the exact authorized HUNAR professional.",
  ...
  },
  {
    ...
    answer:
      "Yes, 100%. Every technician on HUNAR undergoes strict biometric NADRA CNIC verification, police background checks, hands-on trade skill testing, and phone verification before being admitted to our verified network.",
    badge: "100% Verified",
    isPopular: true,
  },
  {
  ...
  },
  {
    ...
    answer:
      "All technicians carry official HUNAR photo badges, bring proper insulated safety gear/tools, and follow a strict household decorum checklist.",
  },
  ...
  // QUALITY & GUARANTEE
  {
    id: "faq-guarantee-1",
    category: "guarantee",
    question: "What is the HUNAR 5-Day Craftsmanship Warranty?",
    answer:
      "If a repaired plumbing pipe leaks, an electrical breaker trips, or an AC unit malfunctions within 5 days of completion, HUNAR dispatches the technician back for a 100% free rework or sends an Elite specialist at zero extra charge.",
...
export const MOCK_HELPLINE_INFO: HelplineDeskInfo = {
  ...
  supportEmail: "support@hunar.pk",
  hoursDisplay: "24/7 Round the Clock Support",
  deskLocation: "HUNAR Central Operations & Support Desk",
