...
export function Step4ReviewPost({
  ...
  return (
    <div className="w-full max-w-3xl mx-auto space-y-4 animate-in fade-in-50 duration-300 pb-6">
      {/* Header Section */}
      <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-5 col-span-1 md:col-span-2 relative overflow-hidden group">
          <button
            type="button"
            onClick={() => onGoToStep(2)}
            className="absolute top-3.5 right-3.5 rtl:right-auto rtl:left-3.5 p-1.5 text-[#0F766E] hover:bg-slate-50 rounded-lg transition-colors cursor-pointer"
          ...
          <div className="flex items-start gap-3.5">
            <div
              className={`size-12 rounded-xl flex items-center justify-center shrink-0 ${
                selectedCategory?.iconBg || "bg-slate-50"
              } ${selectedCategory?.iconColor || "text-[#0F766E]"}`}
            >
            ...
            <div className="flex-1 pr-6 rtl:pr-0 rtl:pl-6 space-y-1">
              <div className="flex items-center gap-2">
                <span className="inline-block px-2.5 py-0.5 bg-[#0F766E]/10 text-[#0F766E] rounded-full text-[11px] font-bold">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-5 relative overflow-hidden flex flex-col justify-between">
          <button
            type="button"
            onClick={() => onGoToStep(2)}
            className="absolute top-3.5 right-3.5 rtl:right-auto rtl:left-3.5 p-1.5 text-[#0F766E] hover:bg-slate-50 rounded-lg transition-colors cursor-pointer"
          ...
          <div>
            <div className="flex items-center gap-1.5 mb-2 text-slate-600">
              <Volume2 className="size-4 text-[#0F766E]" />
          ...
          {data.voiceNoteUrl ? (
            <div className="p-2.5 bg-slate-50/80 rounded-xl flex items-center gap-2 mt-2">
              <audio
              ...
              <button
                ...
                className="size-8 rounded-full bg-[#0F766E] text-white flex items-center justify-center shrink-0 shadow-xs hover:bg-[#115E59] cursor-pointer"
              >
                {isPlayingAudio ? (
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between text-[11px] font-semibold text-[#123B5D] mb-1">
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-slate-50 rounded-lg text-xs font-semibold text-[#123B5D]">
                  <Calendar className="size-3 text-[#0F766E]" />
                  {data.preferredDate || (isUrdu ? "آج" : "Today")}
                </span>
                <span className="inline-flex items-center px-2.5 py-1 bg-slate-50 rounded-lg text-xs font-semibold text-[#123B5D]">
      ...
      {/* Satisfaction & Verification Trust Banner (Pure White, No Border) */}
      <div className="p-3.5 rounded-2xl bg-white shadow-2xs flex items-center justify-between gap-3">
      ...
      <div className="pt-3 flex items-center justify-between gap-4">
        <button
          type="button"
          onClick={() => onGoToStep(3)}
          className="px-5 py-2.5 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-xs transition-colors flex items-center gap-1.5 cursor-pointer"
        >
        ...
        <button
          ...
          onClick={onSubmit}
          className="px-6 py-2.5 rounded-full bg-[#0F766E] hover:bg-[#115E59] text-white font-bold text-xs sm:text-sm shadow-sm flex items-center gap-2 transition-all active:scale-[0.99] cursor-pointer disabled:opacity-50"
        >
          {isSubmitting ? (
